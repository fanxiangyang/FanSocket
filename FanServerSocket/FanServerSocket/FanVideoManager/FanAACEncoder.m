...
@interface FanAACEncoder()
@property (nonatomic) AudioConverterRef audioConverter;//音频转换对象
@property (nonatomic) uint8_t *aacBuffer;//音频buff
@property (nonatomic) NSUInteger aacBufferSize;//音频buff大小
@property (nonatomic) char *pcmBuffer;//pcm格式buff
@property (nonatomic) size_t pcmBufferSize;//pcm格式数据大小

@end
@implementation FanAACEncoder
                                           ...
                                           fromManufacturer:(UInt32)manufacturer
{
    ...
    UInt32 size;
    //检索有关给定属性的信息，kAudioFormatProperty_Encoders=音频格式属性ID ，大小，说明符是座位输入参数的数据的缓冲区，属性值大小
...
{
    FanAACEncoder *encoder = (__bridge FanAACEncoder *)(inUserData);
